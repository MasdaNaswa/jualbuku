            ...
            <div class="flex justify-center self-center z-10">
                <div class="p-12 bg-white mx-auto rounded-3xl w-96 shadow-lg">
                    <div class="mb-7 text-center">
                        <h3 class="font-bold text-2xl text-blue-400">Daftar Akun Admin</h3>
                    </div>
                    <form action="{{ route('register.admin') }}" method="POST" class="space-y-6">
                        @csrf
                        <div class="">
                            <input
                                class=" w-full text-sm  px-4 py-3 bg-gray-200 focus:bg-gray-100 border  border-gray-200 rounded-lg focus:outline-none focus:border-blue-400 @error('username') border-red-500 @enderror"
                                type="text" placeholder="Nama Pengguna" name="username">
                            @error('username')
                        ...
                        <div class="relative" x-data="{ show: true }">
                            <input placeholder="Kata Sandi" :type="show ? 'password' : 'text'"
                                class="text-sm text-black-200 px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-purple-400 @error('password') border-red-500 @enderror"
                                name="password">
                            @error('password')
                                <span class="text-red-500 text-xs">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="relative" x-data="{ show: true }">
                            <input placeholder="Konfirmasi Kata Sandi" :type="show ? 'password' : 'text'"
                                class="text-sm text-black-200 px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-purple-400 @error('password_confirmation') border-red-500 @enderror"
                        ...
                        <div class="mb-7 text-center">
                            <p class="text-gray-400 text-s">Sudah Punya Akun? <a href="{{ route('login.admin') }}"
