            ...
            <div class="flex justify-center self-center z-10">
                <div class="p-12 bg-white mx-auto rounded-3xl w-96 shadow-lg">
                    <div class="mb-7 text-center">
                        <h3 class="font-bold text-2xl text-blue-400">Ubah Kata Sando</h3>
                    </div>
                    <form action="{{ route('reset-password.update', $token) }}" method="POST" class="space-y-6">
                        @csrf
                        <div class="">
                            ...
                            <input
                                ...
                                type="email" placeholder="Email" name="" value="{{ $email }}" readonly>
                            @error('email')
