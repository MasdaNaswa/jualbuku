        ...
        <div class="container-xl">
            <div class="flex flex-col lg:flex-row">
                <div class="col-md-12">
                    ...
                    <div class="text-gray-600 text-m text-center py-5">Tembus batas dunia imajinasi dengan novel-novel
                        pilihan kami! Jelajahi petualangan yang tak terlupakan, cinta yang menggugah, dan misteri yang
                        menggetarkan. Temukan cerita-cerita yang akan memikat hati dan pikiran Anda di sini
					</div>
					<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="0">
						<div class="carousel-inner">
							@forelse($produk->where('kode_kategori', 2)->chunk(4) as $chunk)
