...
<div class="container-xl">
	<div class="flex flex-col lg:flex-row">
		<div class="col-md-12">
			...
			<div class="text-gray-600 text-m text-center py-5">Temukan pengalaman membaca yang tak terlupakan dengan rekomendasi buku fiksi kami! Dari romansa yang mengharukan hingga misteri yang menggetarkan, jelajahi cerita-cerita paling menarik di sini
			</div>
			<div id="myCarousel" class="carousel slide" data-ride="carousel" data-interval="0">
				<div class="carousel-inner">
					@forelse($produk->where('kode_kategori', 4)->chunk(4) as $chunk)
