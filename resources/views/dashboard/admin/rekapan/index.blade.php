                ...
                <table class="min-w-full bg-white">
                    <thead class="px-4 py-3 font-medium text-gray-900  dark:text-black bg-blue-900 hover:bg-blue-800">
                        <tr>
                            ...
                            <th class="py-2 px-4 border-b text-sm">Cetak Resi</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="py-2 px-4 border-b text-black text-sm">
                                <a href="{{ route('ringkasan.exportResiPDF', $item->kode_pesanan) }}" class="bg-blue-400 px-3 py-2 rounded-lg">Cetak</a>
                            </td>
                        </tr>
                        @empty
                        <tr>
