    ...
    <div class="flex min-h-screen 2xl:max-w-7xl 2xl:mx-auto 2xl:border-x-2 2xl:border-indigo-50 ">
        ...
        <div class="main--content">
            ...
            <div class="max-w-screen py-4 bg-white shadow-md rounded-lg px-20">
                <div
                    class="w-full md:w-auto flex flex-col mb-3 md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-start md:space-x-3 flex-shrink-0">
                    <button id="openModal"
                        class="bg-blue-500 text-white py-2 px-4 rounded-lg hover:bg-blue-700">Tambah</button>
                </div>
                <!-- Price -->
                <div class="container mx-auto">
                    <div class="overflow-x-auto rounded-lg px-80 mr-3">
                        <table class="min-w-full bg-white">
                            <thead
                                class="px-4 py-3 font-medium text-gray-900  dark:text-black bg-blue-900 hover:bg-blue-800">
                                <tr>
                                    <th class="py-2 px-4 border-b text-sm" style="min-width: 200px;">No</th>
                                    <th class="py-2 px-4 border-b text-sm" style="min-width: 200px;">Nama Kategori</th>
                                    <th class="py-2 px-4 border-b text-sm" style="min-width: 200px;">kode Buku</th>
                                </tr>
                            </thead>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="py-2 px-4 border-b text-black text-sm">12/06/2024</td>
                                    <td class="py-2 px-4 border-b text-black text-sm">elys</td>
                                </tr>
                            </tbody>
                    </div>
