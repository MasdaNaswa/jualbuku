        ...
        <div
            ...
            <div class="flex justify-center self-center z-10">
                <div class="p-12 bg-white mx-auto rounded-3xl w-96 shadow-lg">
                    ...
                    <form action="{{route('login_proses_admin')}}" method="POST">
                        @csrf
                        <div class="space-y-6">
                            <div class="">
                                <input
                        ...
                        @enderror
                            <div class="flex items-center justify-between">
                                ...
                                <div class="text-xs ml-auto">
                                    <a href="{{route('lupa_admin')}}" class="text-blue-400 hover:text-blue-700">
                                        Lupa Kata Sandi?
                                    </a>
                                </div>
                            </div>
                            <div class="mb-7 text-center">
                                <p class="text-gray-400 text-s">Belum Mendaftar? <a href="{{route('register-admin')}}"
