...
<form action="{{ route('register_proses_admin')}}" method="POST">
<div class="absolute top-0 left-0 h-full w-full overflow-hidden">
    <div class="bg-cover bg-center h-full w-full"
        ...
        <div class="relative min-h-screen sm:flex sm:flex-row justify-left bg-transparent rounded-3xl shadow-xl lg">
            <div class="flex-col flex self-center lg:px-14 sm:max-w-4xl xl:max-w-md z-10"></div>
