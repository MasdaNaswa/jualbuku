...
<div
    ...
    <div class="p-12 bg-white mx-auto rounded-3xl w-96 shadow-lg">
        <div class="mb-7 text-center">
				<h3 class="font-bold text-2xl text-blue-400">Daftar Akun </h3>
			</div>
			<div class="space-y-6">
				<div class="">
              ...
              <div class="">
					...
					<div class="relative" x-data="{ show: true }">
						<input placeholder="Kata Sandi" :type="show ? 'password' : 'text'" class="text-sm text-black-200 px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-purple-400">
                    ...
                    <div class="relative" x-data="{ show: true }">
						<input placeholder="Konfirmasi Kata Sandi" :type="show ? 'password' : 'text'" class="text-sm text-black-200 px-4 py-3 rounded-lg w-full bg-gray-200 focus:bg-gray-100 border border-gray-200 focus:outline-none focus:border-purple-400">
						<div class="flex items-center absolute inset-y-0 right-0 mr-3  text-sm leading-5">
                    ...
                    <div class="mb-7 text-center">
                        <p class="text-gray-400 text-s">Sudah Punya Akun? <a href="login-pembeli" class="text-sm text-blue-400 hover:text-blue-700">Masuk</a></p></div>
