...
<html lang="en">
    ...
    <header>
        ...
        <div class="flex flex-col justify-center px-4 py-4 bg-white max-md:pl-5">
            <div
                class="flex flex-col pt-4 pb-11 mt-12 bg-white rounded-xl shadow-md max-md:mt-10 max-md:max-w-full"
            >
                <div class="flex justify-start mx-4 items-center text-3xl text-cyan-700">
                    <img
                        src="images/ringkas.png"
                        alt="Order summary icon"
                        class="shrink-0 w-[50px]"
                    />
                ...
                <div class="flex gap-10 mx-4 max-md:flex-col max-md:gap-0">
                    ...
                    <div
                        class="px-8 py-8 w-full h-min bg-white rounded-xl shadow-md max-md:px-5 max-h-min"
                    >
                        <div class="flex max-md:flex-col">
                            <div class="flex flex-col grow">
                                ...
                                <div
                                    class="flex mt-4 justify-between items-start text-base font-thin text-neutral-600"
                                >
                ...
                <div class="flex justify-end mx-4">
                    <a
                        class="justify-center ml-6 items-center py-2 mt-8 font-bold text-center text-white bg-blue-400 rounded-xl w-[227px]"
                        href="dashboard"
                    >
                        Kembali Beranda
                    </a>
